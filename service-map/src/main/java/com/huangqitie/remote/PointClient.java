...
import com.huangqitie.internalcommon.request.PointDTO;
...
public class PointClient {
    ...
    public ResponseResult upload(PointRequest pointRequest) {
        ...
        url.append(MapConfigConstant.POINT_UPLOAD);
        url.append("?");
        ...
        ResponseEntity<String>
                stringResponseEntity = restTemplate.postForEntity(URI.create(url.toString()), null, String.class);
